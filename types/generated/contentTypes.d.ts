...
export interface ApiFuncionarioFuncionario extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    autoridad: Schema.Attribute.Enumeration<
      ['intendente', 'secretarios', 'directores']
    > &
      Schema.Attribute.Required;
...
export interface ApiHeroHero extends Struct.CollectionTypeSchema {
  collectionName: 'imagenes_hero';
  info: {
    displayName: 'Hero';
    pluralName: 'imagenes-hero';
    singularName: 'hero';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::hero.hero'> &
      Schema.Attribute.Private;
    posicion_x: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<50>;
    posicion_y: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<50>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiOrdenanzaOrdenanza extends Struct.CollectionTypeSchema {
  collectionName: 'ordenanzas';
  info: {
    displayName: 'Ordenanza';
    pluralName: 'ordenanzas';
    singularName: 'ordenanza';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiPublicacionDeLeyPublicacionDeLey
  ...
  info: {
    displayName: 'Publicaci\u00F3n de ley';
    pluralName: 'publicacion-de-leys';
    singularName: 'publicacion-de-ley';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::publicacion-de-ley.publicacion-de-ley'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'titulo'> & Schema.Attribute.Required;
...
export interface ApiRedSocialRedSocial extends Struct.SingleTypeSchema {
  ...
  info: {
    displayName: 'Redes';
    pluralName: 'redes-sociales';
    singularName: 'red-social';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiTransparenciaTransparencia
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ejecucion_presupuestaria: Schema.Attribute.Component<
      'informe-trimestral.informe-trimestral',
      true
    >;
    fecha: Schema.Attribute.String;
    gastos_finalidad_funcion: Schema.Attribute.Component<
      'informe-trimestral.informe-trimestral',
      true
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    presupuesto: Schema.Attribute.Media<'files'>;
    publishedAt: Schema.Attribute.DateTime;
    situacion_economico_financiera: Schema.Attribute.Component<
      'informe-trimestral.informe-trimestral',
      true
    >;
    stock_deuda: Schema.Attribute.Component<
      'informe-trimestral.informe-trimestral',
      true
    >;
    updatedAt: Schema.Attribute.DateTime;
